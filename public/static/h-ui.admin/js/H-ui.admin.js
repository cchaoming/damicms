...
function creatIframe(href,titleName){
	...
	iframeBox.hide();
	iframe_box.append('<div class="show_iframe"><div class="loading"></div><iframe frameborder="0" name="main" id="main_frame" src='+href+'></iframe></div>');
...
$(function(){
	...
	$(".cl").on("click",".navbar-levelone a",function(){
